          ...
          <div class="card">
            <div class="card-body">
              ...
              <div style="position: relative;" class="mb-5">
                <a href="/admin/academics/studymaterials-create-page" style="position: absolute;right:20px; text-decoration:none;"><i class='bx bxs-user-plus' ></i> Add New Study Material</a>
              </div>
