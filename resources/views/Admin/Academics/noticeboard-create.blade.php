              ...
              <h4 class="card-title">Noticeboard | Academics </h4>
                ...
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    ...
                    <div class="form-group">
                        ...
                        <input style="color: greenyellow;" type="radio" id="status" name="status" value="Active" checked> Active
                        <input style="color: red;" type="radio" id="status" name="status" value="Inactive"> Inactive
                        <span style="color: red">@error('url') {{$message}} @enderror</span>
                    </div>
                    <div class="mt-3">
